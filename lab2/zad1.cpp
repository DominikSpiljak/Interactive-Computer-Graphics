...
//	Crtaj moju liniju.
//*********************************************************************************
void myLine0_45(GLint xa, GLint ya, GLint xb, GLint yb){
...
void myLine0_90(GLint xa, GLint ya, GLint xb, GLint yb){
    if (yb - ya <= xb - xa){
...
void myLine0_minus90(GLint xa, GLint ya, GLint xb, GLint yb){
    if (-( yb - ya ) <= xb - xa){
...
void myLine(GLint xa, GLint ya, GLint xb, GLint yb)
{
    ...
    if (xa <= xb ) {
        if (ya <= yb){
            myLine0_90(xa, ya, xb, yb);
        }
        else{
            myLine0_minus90(xa, ya, xb, yb);
        }
    }
    else{
        if (ya >= yb){
            myLine0_90(xb, yb, xa, ya);
        }
        else{
            myLine0_minus90(xb, yb, xa, ya);
        }
    }
}
